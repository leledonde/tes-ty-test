      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                  <h2 className="text-3xl font-light text-gray-800 mb-4">Featured <span className="text-sky-500">Villas</span></h2>
                  <p className="text-gray-600 max-w-2xl mx-auto">Each villa is designed to blend modern with natural surroundings.</p>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  <div className="villa-card bg-white rounded-xl overflow-hidden shadow-md">
                      <div className="relative h-64 overflow-hidden">
                          <Image src="/house.jpg" width={640} height={360} alt="Oceanfront Villa" className="w-full h-full object-cover"/>
                          <div className="absolute top-4 right-4 bg-white/90 px-3 py-1 rounded-full text-sm font-medium">From $450/night</div>
                      </div>
                      <div className="p-6">
                          <h3 className="text-xl font-semibold text-gray-800 mb-2">House1</h3>
                          ...
                          <button className="w-full mt-2 bg-sky-500 hover:bg-sky-600 text-white py-2 rounded-lg transition">View Details</button>
                      </div>
                  </div>

                  <div className="villa-card bg-white rounded-xl overflow-hidden shadow-md">
                      <div className="relative h-64 overflow-hidden">
                          <Image src="/house.jpg" width={640} height={360} alt="Mountain Retreat" className="w-full h-full object-cover" />
                          <div className="absolute top-4 right-4 bg-white/90 px-3 py-1 rounded-full text-sm font-medium">From $380/night</div>
                      </div>
                      <div className="p-6">
                          <h3 className="text-xl font-semibold text-gray-800 mb-2">House2</h3>
                          <div className="flex items-center text-gray-600 mb-4">
                              <Icon.MapPin className="w-4 h-4 mr-1" />
                  ...
                  <div className="villa-card bg-white rounded-xl overflow-hidden shadow-md">
                      <div className="relative h-64 overflow-hidden">
                          <Image src="/house.jpg" width={640} height={360} alt="Desert Oasis" className="w-full h-full object-cover" />
